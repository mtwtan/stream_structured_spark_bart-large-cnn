...
- To get the Amazon reviews data into your S3 bucket, [use or modify the code here](https://github.com/mtwtan/stream_spark_bedrock/blob/main/download/download.py).
